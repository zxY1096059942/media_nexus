<template>
  <div class="home-wrapper">
    <el-card style="margin: 20px 20px 0px 20px; font-size: 14px">
      ...
      <div class="first">
        <ul>
          <li class="li" style="width: 33%">APP账户数
          </li>
          <li class="li" style="width: 33%">APP数
          </li>
        ...
        <ul>
          ...
          <li class="da" style="width: 33%">
             <router-link to="/helper/helperApp">{{ memberAndCartStatisticsObj.appCount }}</router-link>
          </li>
          <li class="da" style="width: 33%">
            {{ memberAndCartStatisticsObj.onlineCount }}
          </li>
        </ul>
      </div>
    </el-card>    
    <el-row class="pl20 pr20" :gutter="10">
      <el-col :span="16">
        <member-line-chart></member-line-chart>
      ...
      <el-col :span="8">
        <el-card style="margin: 20px 20px; font-size: 14px">
          ...
          <el-timeline>
            <el-timeline-item placement="top" timestamp="2024年9月">
              <el-card>
                <h4>项目启动，系统建设规划</h4>
              </el-card>
            </el-timeline-item>
            <el-timeline-item placement="top" timestamp="2024年10月">
              <el-card>
                <h4>信息系统建设，软件系统研发</h4>
              </el-card>
            </el-timeline-item>
            <el-timeline-item placement="top" timestamp="2024年11月">
              <el-card>
                <h4>信息系统建设基础功能完成，上线试用行</h4>
              </el-card>
            </el-timeline-item>
            <el-timeline-item placement="top" timestamp="2024年12月">
              <el-card>
                <h4>系统正式投入使用，软件功能升级维护，运营中</h4>
              </el-card>
            </el-timeline-item>
          </el-timeline>
        </el-card>
...
import MemberLineChart from "@/views/dashboard/MemberLineChart.vue";
